...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 200, description: 'Users retrieved successfully', type: [user_entity_1.User] }),
    __metadata("design:type", Function),
...
__decorate([
    ...
    (0, swagger_1.ApiResponse)({ status: 404, description: 'User not found' }),
    (0, swagger_1.ApiResponse)({ status: 403, description: 'Old password is incorrect' }),
    __param(0, (0, common_1.Param)("id", common_1.ParseUUIDPipe)),
